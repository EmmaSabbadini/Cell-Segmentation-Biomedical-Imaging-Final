...
model = None
model = models.load_model('/Users/calliesardina/Spring_2023/CSCI3397/Cell-Segmentation-Biomedical-Imaging-Final/logs/exp-original/unet_efficientnetb3_multiclass.h5', compile=False)
#model.summary()
...
for i in range(5):
    ...
    pred_filt = cv2.medianBlur(pred.astype(np.uint8), 7)
